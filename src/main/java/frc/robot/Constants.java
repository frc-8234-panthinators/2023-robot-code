...
public final class Constants {
  ...
  public static final double normalSpeedMultiplier = 0.8;//The multiplier for how fast the robot normally runs at max speed
  ...
  public static final double armZRotRate = 200;//The maximum rate at which the arm rotates when the motor is engaged
  public static final double armZCompRate = 0.5;
  ...
  public static final double autonomousSpeed = 0.5;//This is the speed at which the robot travels in autonomous
  ...
  // AUTONOMOUS VALUES
  public static final double armExtendTime = 3;
}
